...
namespace MvcMusicStore.Mediatr
{
    public class Mediator : IMediator
    {
        ...
        public Mediator(IKernel kernel)
        {
            _kernel = kernel;
        }
        ...
        private RequestHandler<TResponse> GetHandler<TResponse>(IRequest<TResponse> request)
        {
            ...
            var handler = _kernel.Get(handlerType);
        ...
        {
            return _kernel.GetAll<INotificationHandler<TNotification>>();
        }

        private IEnumerable<IAsyncNotificationHandler<TNotification>> GetAsyncNotificationHandlers<TNotification>()
            where TNotification : IAsyncNotification
        {
            return  _kernel.GetAll<IAsyncNotificationHandler<TNotification>>();
        }
